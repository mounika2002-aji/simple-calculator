...
# These operator check if one object is a part of another object
# it returns True if one Object is part of another otherwise returns False
# it check the membership of one object into another object

# Operators --> in, not in

##first_state = 'Python' in 'Python programming class'
##print(first_state)
##
##second_state = 'Apple' in 'Python programming class'
##print(second_state)
##
##third_state = 'x' in ['a', 'b', 'c', 'x']
##print(third_state)
##
##fourth_state = 'class' in ['a', 'b', 'c', 'x']
##print(fourth_state)
##
##fifth_state = 'class' not in ['a', 'b', 'c', 'x']
##print(fifth_state)
